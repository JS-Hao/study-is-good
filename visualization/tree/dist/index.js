...
var ctx = canvas.getContext("2d"); // 将坐标平移到左下角，并将 y 轴向上
...
function drawBranch(ctx, v0, length, thickness, dir, bias) {
  var v = new _vector2d.default(0, 1).rotate(dir).scale(length);
  ...
  if (thickness > 2) {
    var left = Math.PI / 9 + 0.5 * (dir + 0.2) + bias * (Math.random() - 0.5);
    drawBranch(ctx, v1, length * 0.9, thickness * 0.8, left, bias * 0.9);
    var right = Math.PI / 9 + 0.5 * (dir - 0.2) + bias * (Math.random() - 0.5);
...
var dir = 0;
var bias = 4;
var rootV = new _vector2d.default(0, 1).scale(length);
ctx.lineWidth = thickness;
ctx.beginPath();
ctx.moveTo(0, 0);
...
},{"./vector2d":"vector2d.js"}],"../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
